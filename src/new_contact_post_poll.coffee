 Zap.new_contact_post_poll = (bundle) ->
     ...
     for field in results.contacts
      ...
      if results.contacts.length is 0
        field.first_name = null
        field.last_name = null
        field.name = null
        field.title = null
        field.addresses[0] = null
        field.email_addresses[0] = null
        field.instant_messengers[0] = null
        field.web_sites[0] = null
        field.custom_field_values[0] = null
    
      if field.addresses.length is 0
      ...
      if field.phone_numbers.length is 0
        field.phone_numbers.push
          number: null

      if field.email_addresses.length is 0
        field.email_addresses.push
          address: null

      if field.instant_messengers.length is 0
        field.instant_messengers.push
          address: null

      if field.web_sites.length is 0
        field.web_sites.push
          address: null

      if field.custom_field_values.length is 0
      ...
      if typeof field.custom_field_values[0].matter is "undefined"
       ...
       array.push 
         ...
         intant_messenger: field.intant_messengers[0].address
